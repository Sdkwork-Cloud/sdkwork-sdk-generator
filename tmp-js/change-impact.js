...
const VERIFICATION_TRIGGER_AREAS = new Set([
    'api-surface',
    'models',
    'runtime',
    'build-metadata',
...
export function analyzeChangeImpact(changes) {
...
function isModelPath(segments, fileName) {
...
function isApiSurfacePath(segments, fileName) {
...
function buildImpactSummary(areas, requiresVerification) {
    if (areas.length === 0) {
