...
export function getPhpType(schema, config) {
...
function getPhpPrimitiveType(type) {
    if (type === 'string')
        return 'string';
    if (type === 'number')
        return 'float';
...
export function getPhpNamespace(config) {
...
export function getPhpPackageName(config) {
