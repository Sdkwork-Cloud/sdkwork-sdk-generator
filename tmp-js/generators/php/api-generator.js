...
${returnLine}
    ...
    createNamedParameterBindings(parameters, reservedNames) {
        ...
        const safeNameByKey = createUniqueIdentifierMap(keys, (key) => PHP_CONFIG.namingConventions.propertyName(rawNameByKey.get(key) || 'value'), reservedNames);
    ...
    renderNamedParameterArray(bindings, indentation) {
