...
${queryBlock}${requestHeaderBlock}        val raw = ${call}
    ...
    createNamedParameterBindings(parameters, knownModels, reservedNames) {
        ...
        const safeNameByKey = createUniqueIdentifierMap(keys, (key) => KOTLIN_CONFIG.namingConventions.propertyName(rawNameByKey.get(key) || 'value'), reservedNames);
