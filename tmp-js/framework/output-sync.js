...
function collectStaleGeneratedRootFiles(outputDir, generatedFiles, previousManifest, nextGeneratedPaths) {
...
function resolveGeneratedScanRoots(generatedFiles, previousManifest) {
    const roots = new Set();
...
function generatedScanRootForPath(relativePath) {
...
function walkGeneratedRoot(outputDir, currentPath, onFile) {
