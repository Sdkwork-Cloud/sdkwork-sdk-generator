...
import {
  RustUsagePlanner,
  resolveRustExpectedRequestPath,
  type RustUsagePlan,
...
export class TestGenerator {
  ...
  private generateSmokeTest(plan: RustUsagePlan, config: GeneratorConfig): string {
...
`);
  ...
  private buildAssertions(plan: RustUsagePlan, expectedPath: string): string {
