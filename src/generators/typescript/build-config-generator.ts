...
import {
  resolveDefaultPackageToken,
  resolveDefaultTypeScriptPackageName,
} from '../../framework/package-identity.js';
...
export class BuildConfigGenerator {
  ...
  private generatePackageJson(config: GeneratorConfig): GeneratedFile {
