...
const SUPPORTED_PUBLISH_LANGUAGES: ReadonlySet<Language> = new Set(getPublishSupportedLanguages());
...
function createPublishShellScript(language: Language): string {
...
function createPublishPowerShellScript(language: Language): string {
...
export function generatePublishBinScripts(language: Language): GeneratedFile[] {
...
export function generateTypeScriptBuildBinScripts(config: GeneratorConfig): GeneratedFile[] {
